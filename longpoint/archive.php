...
<div id="conetnt">
    <div class="container voffset5 voffsetd5">
    	<h1 class="page-title">
					<?php
						if ( is_day() ) :
							printf( __( 'Daily Archives: %s', 'Longpoint' ), get_the_date() );

						elseif ( is_month() ) :
							printf( __( 'Monthly Archives: %s', 'Longpoint' ), get_the_date( _x( 'F Y', 'monthly archives date format', 'Longpoint' ) ) );

						elseif ( is_year() ) :
							printf( __( 'Yearly Archives: %s', 'Longpoint' ), get_the_date( _x( 'Y', 'yearly archives date format', 'Longpoint' ) ) );

						else :
							_e( 'Archives', 'Longpoint' );
